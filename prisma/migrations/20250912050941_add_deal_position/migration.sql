...
INSERT INTO "new_Deal" ("assignedToId", "closeDate", "companyId", "contactId", "createdAt", "id", "name", "notes", "probability", "stage", "updatedAt", "userId", "value") SELECT "assignedToId", "closeDate", "companyId", "contactId", "createdAt", "id", "name", "notes", "probability", "stage", "updatedAt", "userId", "value" FROM "Deal";
DROP TABLE "Deal";
